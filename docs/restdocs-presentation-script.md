...
## 12-2. Asciidoctor → REST Docs HTML (0:23)
- [슬라이드 13-2]
...
## 13. 품질/꾸미기 팁 (0:22–0:24)
- [슬라이드 15]
- “ConstraintDescriptions로 Bean Validation 규칙을 자동으로 설명하고, 공통 헤더/에러 조각 문서는 재사용 가능한 설명 정보로 관리하세요. Asciidoctor 테마로 문서 톤을 맞춥니다.”

---

## 14. 데모 진행 대본 (0:24–0:30)
- [슬라이드 16]
